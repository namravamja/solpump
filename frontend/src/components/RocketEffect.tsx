    ...
    <div className="relative w-full h-[50vh] lg:h-[78vh] min-h-[50vh] lg:min-h-[78vh] flex justify-center items-start flex-none">
      ...
      >
        ...
        <video
          ...
          onLoadedData={() => console.log("[v0] Background video loaded successfully")}
          onError={(e) => {
            console.error("[v0] Background video failed to load:", e);
            const video = e.target as HTMLVideoElement;
            console.error("[v0] Video src:", video.src);
            ...
            >
              <video
                ...
                onError={(e) => {
                  ...
                  const video = e.target as HTMLVideoElement;
                  console.error("[v0] Boom video src:", video.src);
                  console.error("[v0] Boom video error:", video.error);
                }}
                onAbort={(e) => {
                  console.log(
